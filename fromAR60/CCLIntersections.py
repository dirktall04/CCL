...
@author: kyleg
Updated: 2014-12-29 by DAT
Updated: 2015-06-22 by DAT
'''
...
def NONSTATE_INT():
    ...
    CalculateField_management("INTR_CCL_NS Events", schema+"INTR_CCL_NS_Features.CITY", "!GIS.CITY_LIMITS.CITY!", "PYTHON_9.3")
...
def STATE_INT():
    ...
    CalculateField_management("INTR_CCL_Events", schema+"INTR_CCL_Features.CITY", "!GIS.CITY_LIMITS.CITY!", "PYTHON_9.3")
