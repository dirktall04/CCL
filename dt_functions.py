...
@author: dtalley
Updated 2015-07-28 by dtalley
Updated 2015-12-15 by dtalley
-- Added the defaultPythonLoggingTable variable.
'''
...
def ScriptStatusLogging(taskName = 'Unavailable', taskTarget = 'Unknown',
    ...
    try:
        ...
        pythonLoggingFieldList = ['Process_Name','Table_Name', 'Status', 'Start_Date', # Status 0x0 = Success, 0x1 = Failure.
        ...
        if completionStatus == scriptSuccess or completionStatus == scriptFailure: # Received the correct status format.
            ...
            cursor = da.InsertCursor(pythonLoggingTable, pythonLoggingFieldList)  # @UndefinedVariable
